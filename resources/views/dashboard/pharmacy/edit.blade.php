<x-front-layout>
    ...
    <div class="row">
        <form action="{{ route('pharmacy.update', $bill->id)}}" method="post" class="w-100" enctype="multipart/form-data">
            @csrf
            @method('put')
                        ...
                        <table class="table table-striped table-hover" id="medicines_table">
                            ...
                            <tbody>
                                @foreach ($medicines as $medicine)
                                    <tr>
                                        <td>
                                            <input type="checkbox" id="checkbox_{{ $medicine->id }}" name="medicines_id[]" value="{{$medicine->id}}" class="form-control" checked>
                                        </td>
