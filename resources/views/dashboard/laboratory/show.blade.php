<x-front-layout>
    ...
    <div class="row">
        <form action="{{ route('laboratory.reservation')}}" method="get" class="w-100">
            @csrf
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">هل تريد حذف الفحصوات صاحبة الرقم : {{$reservation->id}}</h5>
